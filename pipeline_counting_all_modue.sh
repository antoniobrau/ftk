...
EXEC="./build/counting_tracks_eseguibile"  # cambia col tuo eseguibile

mkdir -p "$BUILD_DIR"

for f in $(seq 0 48); do
  in="/home/abrau/code/data/fulltrack_${f}.txt"
  out="/home/abrau/code/data/fulltrack_${f}_counting.txt"
